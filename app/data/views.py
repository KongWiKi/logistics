...
from . import data
from .dataMysql import alarmtype_numbers,dayCount,speedCount,longLat

@data.route('/')
def index():
    return "<h2>这里是数据路由</h2>" \
           "<a href='http://127.0.0.1:5000/data/alarmtypeNumbers'>事件类型发生次数统计</a><br>" \
           "<a href='http://127.0.0.1:5000/data/dayCounts'>每天发生的事故</a><br>" \
           "<a href='http://127.0.0.1:5000/data/speedCounts'>车速统计</a><br>" \
           "<a href='http://127.0.0.1:5000/data/lngLat'>经纬度</a><br>" \
