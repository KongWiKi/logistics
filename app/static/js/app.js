...
var pageData = {
    ...
    'general':function generalData(){
        echartsRadarDriver = echarts.init(document.getElementById('tpl-echarts-Radar-Driver'));
        optionRadarDriver = {
    title: {
        text: '基础雷达图'
    },
    ...
    series: [{
        ...
        echartsRadarDriver.setOption(optionRadarDriver);

        echartsRadarTeam = echarts.init(document.getElementById('tpl-echarts-Radar-Team'));
        optionRadarTeam = {
    title: {
        text: '基础雷达图'
    },
    ...
    series: [{
        ...
        echartsRadarTeam.setOption(optionRadarTeam)
